...
function DataTable({
    ...
    return (
        <div className="overflow-x-auto">
            {/* Table Header */}
            <div
                className={`grid grid-cols-2 sm:grid-cols-${headers.length} gap-2 bg-[#16A34A] text-center font-semibold text-xs sm:text-sm text-white p-1 rounded-t-xl`}>
                ...
                {data.length < 1 ? (
                    ...
                    data.map((item, index) => (
                        <div
                            ...
                            {actions && (
                                <div
                                    className="p-2 flex justify-center space-x-0 sm:space-x-2 md:space-x-2 lg:space-x-6 text-[#183153]">
                                    <button
                                        id="view-icon"
                                        className="px-4 sm:px-2 text-gray-500 rounded-lg transition-all"
